...
const CourseModal = ({isOpen, onClose, id, deleteButtonHandler, 
    addLectureHandler, courseTitle, lectures=[1,2,3,4,5,6,7,8],}) => {
  ...
  return (
    <Modal  isOpen={isOpen} size={'full'} onClose={handleClose} scrollBehavior='outside'>
        {/* scroll behavior outside to not show footer while scrolling */}
...

{
    lectures.map((item, i)=>(
        ...
        key={i}
        title='React Intro' 
        description= 'This is a intro lecture where you will learn the basics of react'
        num= {i + 1} 
        lectureId= 'qfdvwcdv' 
        courseId= {id}
